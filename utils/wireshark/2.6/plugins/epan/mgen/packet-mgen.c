...
proto_register_mgen(void)
{
  ...
  range_convert_str(wmem_epan_scope(),&global_mgen_udp_range, MGEN_PORT_DEFAULTS, 65535);
  mgen_udp_range = range_empty(NULL);
...
proto_reg_handoff_mgen(void)
{
  ...
  mgen_udp_range = range_copy(NULL,global_mgen_udp_range);
