...
class NormSession
{
    ...
    public:
        ...
        void SetWindowFlowControl(bool state);
        void SetSsmSrcPort(UINT16 port);
    ...
    private:
        ...
        // GNAT-compatible flow control parameters.
        FlowController*                 fc;

        // The source port portion of SSM, if any.
        UINT16                          ssm_src_port;
