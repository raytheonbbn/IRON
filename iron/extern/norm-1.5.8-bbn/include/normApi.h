...
typedef enum NORM_API_LINKAGE NormObjectType
{
    NORM_OBJECT_NONE,
    NORM_OBJECT_DATA,
    NORM_OBJECT_FILE,
...
typedef enum NORM_API_LINKAGE NormFlushMode
{
    NORM_FLUSH_NONE,
    NORM_FLUSH_PASSIVE,
    NORM_FLUSH_ACTIVE   
...
typedef enum NORM_API_LINKAGE NormNackingMode
{
    NORM_NACK_NONE,
    NORM_NACK_INFO_ONLY,
    NORM_NACK_NORMAL  
...
typedef enum NORM_API_LINKAGE NormAckingStatus
{
    NORM_ACK_INVALID,
    NORM_ACK_FAILURE,
    NORM_ACK_PENDING,
...
typedef enum NORM_API_LINKAGE NormTrackingStatus
{
    NORM_TRACK_NONE,
...
typedef enum NORM_API_LINKAGE NormProbingMode
{
    NORM_PROBE_NONE,
    NORM_PROBE_PASSIVE,
    NORM_PROBE_ACTIVE  
...
typedef enum NORM_API_LINKAGE NormSyncPolicy
{
...
typedef enum NORM_API_LINKAGE NormRepairBoundary
{
    NORM_BOUNDARY_BLOCK,
    NORM_BOUNDARY_OBJECT
} NormRepairBoundary;
    
typedef enum NORM_API_LINKAGE NormEventType
{
...
NORM_API_LINKAGE
void NormSetWindowFlowControl(NormSessionHandle sessionHandle, bool enable);

NORM_API_LINKAGE
void NormSetSsmSrcPort(NormSessionHandle sessionHandle, unsigned int port);
